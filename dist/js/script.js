$(document).ready(function () {
  ...
  // Generating slides
  let arrCities = ['Marble', 'Tanga', 'Coral', 'Terrazzo', 'Quartzite', 'Mazera', 'Travertine', 'Granite', 'Limestone', 'Basalt', 'Slate', 'Bush stone', 'Cabro', 'Pebbles']; // Change number of slides in CSS also
...
// Automate slides
  ...
  // Call startAutoPlay() to begin autoplay
  startAutoPlay();
